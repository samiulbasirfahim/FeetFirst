    ...
    return (
        <KeyboardAvoidingLayout className="bg-backgroundDark">
            <InputPassword
                Icon={LOCK}
                placeholder={
                    isGerman() ? "Geben Sie Ihr aktuelles Passwort ein" : "Inserisci la password corrente"
                }
            />
            ...
            <InputPassword
                Icon={LOCK}
                placeholder={
                    isGerman() ? "Geben Sie das neue Passwort ein" : "Inserisci la nuova password"
                }
            />
            <InputPassword
                Icon={LOCK}
                placeholder={
                    isGerman() ? "Geben Sie das Bestätigungspasswort ein" : "Inserisci conferma password"
                }
            />
