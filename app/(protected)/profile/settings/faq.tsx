...
export default function Screen() {
  ...
  const lines = isGerman() ? supportText.de : supportText.it;
  ...
  const renderSupportItem = ({ item }: any) => {
      ...
      <View className="border-b border-gray-600">
        ...
        <Collapsible collapsed={!isActive}>
          <Text className="text-gray-400 mb-3">
            Hier könnten Inhalte für {item} stehen…
          </Text>
        </Collapsible>
      </View>
    );
          ...
          <View>
            <View className="flex-row gap-6 px-4 items-center my-12">
              ...
              <View className="flex-1">
                <Text className="text-white mb-2">{lines[0]}</Text>
                <Text className="text-white mb-2">{lines[1]}</Text>
                <Text className="text-white underline">{lines[2]}</Text>
              </View>
            </View>
            <VersionInfo />
          </View>
