...
export default function Screen() {
    ...
    return (
        <Layout noPadding className="bg-backgroundDark">
            ...
            <View className="p-3 justify-center items-center flex-1">
                <Typography variant="caption">
                    {isGerman() ? "In Kürze verfügbar" : "Disponibile a breve"}
                </Typography>
            </View>
                ...
                <>
                    <View className="p-3 gap-4">
                        ...
                        <ShoppingDropDown
                            placeHolder={
                                isGerman()
                                    ? "Vom gesamten letzten Jahr"
                                    : "Dall'intero ultimo anno"
                            }
                            onChange={(data) => {
                                console.log(data);
                            }}
                        ...
                        <ShoppingDropDown
                            placeHolder={
                                isGerman() ? "Alle Kategorien" : "Tutte le categorie"
                            }
                            onChange={(data) => {
                                console.log(data);
                            }}
