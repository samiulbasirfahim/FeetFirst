  ...
  return (
    <Layout scrollable noPadding avoidTabbar className="p-6 bg-backgroundDark">
      ...
      <View className="bg-muted-background p-4 rounded-2xl flex-row justify-between">
        <Image className="w-1/2 h-9" source={logo} />
      ...
      <View className="my-4">
        <Typography className="text-white text-2xl mb-2">Your Foot Measures</Typography>

          <View className="bg-muted-background py-4 px-6 rounded-2xl">
            <Typography className="text-white text-lg border-b border-muted-foreground pb-2">Measure</Typography>
