            ...
            >
              {index !== selectedMarkerIndex ? (
                <View className="p-1 border-2 border-primary/40 rounded-full">
                  <View className="bg-primary/80 w-5 h-5 rounded-full"></View>
                </View>
              ) : (
                <View className="bg-primary w-8 h-8 rounded-full"></View>
              )}
            </Marker>
          ))}
        </MapView>
            ...
            >
              {partners.map((marker, index) => (
                <TouchableOpacity
                  ...
                  className={`mr-3 p-3 rounded-lg border min-w-32 gap-1 ${
