        ...
        links: [
            {
                ...
                imageUrl: require("@/assets/images/exercises/Wadenwanddehnung_ Verbessert Sprunggelenkbeweglichkeit.png"),
            },
            {
                text: "Lunges mit Fersenfokus: Dehnt Waden & fördert Stabilität",
                imageUrl: require("@/assets/images/exercises/Lunges mit Fersenfokus_ Dehnt Wade und Sehne.png"),
            },
            {
                text: "Fersensitz-Dehnung: Mobilisiert Fußrücken & entlastet Wadenbereich",
                imageUrl: require("@/assets/images/exercises/Fersensitz-Dehnung: Mobilisiert Spann und Zehen.png"),
            },
        ],
    },
    {
        ...
        links: [
            {
                ...
                imageUrl: require("@/assets/images/exercises/Zehengang im Wechsel_ Fördert Mobilität.png"),
            },
            {
                text: "Fußrollen im Stand: Aktiviert Sprunggelenk und verbessert Abrollbewegung",
                imageUrl: require("@/assets/images/exercises/Fußrollen im Stand_ Aktiviert Fußsohle.png"),
            },
            {
                text: "Barfußgehen auf unebenem Untergrund: Trainiert Stabilität & Reaktivität",
                imageUrl: require("@/assets/images/exercises/Barfußgehen auf unebenem Untergrund_ Verbessert natürliche Beweglichkeit.png"),
            },
        ],
    },
        ...
        links: [
            {
                ...
                imageUrl: require("@/assets/images/exercises/Plantarfaszien-Dehnung im Stand_ Dehnt Fußsohle.png"),
            },
            {
                text: "Fußgewölbe-Dehnung auf Stufe: Fördert Flexibilität & Gewölbestabilität",
                imageUrl: require("@/assets/images/exercises/Fußgewölbe-Dehnung auf Stufe_ Fördert Elastizität.png"),
            },
            {
        ...
        links: [
            {
                ...
                imageUrl: require("@/assets/images/exercises/Zehenwellen_ Fördert Zehenbeweglichkeit.png"),
            },
            {
                text: "Kreisende Fußbewegungen: Mobilisiert Sprunggelenk",
                imageUrl: require("@/assets/images/exercises/Kreisende Fußbewegungen_ Mobilisiert Sprunggelenk.png"),
            },
            {
                text: "Zehenstrecken & -spreizen: Dehnt und aktiviert Zehenmuskeln",
                imageUrl: require("@/assets/images/exercises/Zehenstrecken & -spreizen_ Dehnt und aktiviert Zehenmuskeln.png"),
            },
        ],
    },
];
...
const germanFootMuscleSections: ExerciseSection[] = [
    {
        ...
        links: [
            ...
            },
            {
                ...
                imageUrl: require("@/assets/images/exercises/Fersenstand mit Armbewegung_ Kräftigt Waden und Fußheber in koordinativer Belastung.png"),
            },
            {
                text: "Fersen-Kick auf instabilem Untergrund: Trainiert Wadenkraft und stärkt die Stabilität der Fußmuskulatur",
                imageUrl: require("@/assets/images/exercises/Fersen-Kick auf instabilem Untergrund_ Trainiert Wadenkraft und stärkt die Stabilität der Fußmuskulatur.png"),
            },
            {
                text: "Fußstretch mit Widerstand: Stärkt Fußmuskulatur und Fußsohle.",
                imageUrl: require("@/assets/images/exercises/Fußstretch mit Widerstand_.png"),
            },
        ],
    },
    {
        ...
        links: [
            {
                ...
                imageUrl: require("@/assets/images/exercises/Band- oder Theraband-Übung_.png"),
            },
            {
                text: "Fersenheben auf einem Bein: Stärkt Fußmuskulatur und fördert das Gleichgewicht",
                imageUrl: require("@/assets/images/exercises/Fersenheben auf einem Bein.png"),
            },
            {
        ...
        links: [
            {
                ...
                imageUrl: require("@/assets/images/exercises/Handtuchgreifen mit den Zehen.png"),
            },
            {
                text: "Short Foot Exercise: Aktiviert und kräftigt die Muskulatur im Fußgewölbe und der Fußsohle.",
                imageUrl: require("@/assets/images/exercises/Short Foot Exercise_.png"),
            },
            {
                text: "Zehenkrallen & -strecken im Wechsel: Fördert Kraft und Koordination in der Fußsohle.",
                imageUrl: require("@/assets/images/exercises/Zehenkrallen & -strecken im Wechsel.png"),
            },
            {
                text: "Einbeinstand instabil: Stärkt Fußsohle, stabilisiert das Gewölbe und fördert Körperkontrolle.",
                imageUrl: require("@/assets/images/exercises/Einbeinstand auf instabiler Unterlage_.png"),
            },
        ],
    },
    {
        ...
        links: [
            ...
            },
            {
                ...
                imageUrl: require("@/assets/images/exercises/Fußgreifen_.png"),
            },
            {
                text: "Kleiner Zehenlift: Stärkt die kleinen Muskeln der Zehen.",
                imageUrl: require("@/assets/images/exercises/Kleiner Zehenlift_.png"),
            },
            {
                text: "Zehenaufstellung und -wellen: Stärkt Muskulatur der Zehen und fördert deren Flexibilität.",
                imageUrl: require("@/assets/images/exercises/Zehenaufstellung und -wellen_.png"),
            },
        ],
    },
];
